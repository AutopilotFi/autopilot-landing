    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4 p-6 rounded-2xl bg-transparent">
        ...
        <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
          <p>
            Autopilot leverages high-frequency allocation technology developed
            by IPOR Labs AG, which has undergone two{" "}
            <a
            ...
            . This technology is currently regarded as one of the most advanced
            solutions for optimised asset allocation in DeFi.
          </p>
          <p>
            [Harvest Foundation] integrates IPOR&apos;s rebalancing technology
            in parallel with its own auto-compounding vault infrastructure to
            create Autopilot&apos;s allocation setups.
          </p>
          <p>
            Harvest&apos;s core vault infrastructure underwent a comprehensive
            audit by Halborn in January 2025. The audit report is available{" "}
            <a
                ...
                <table className="w-full min-w-[600px]">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-3 md:px-4 py-3 text-sm text-gray-700">
                        Spearbit, Open Zeppelin, Trail of Bits, Cantina
                      </td>
                      <td className="px-3 md:px-4 py-3 text-sm text-gray-700">
                        2021 - 2024
                      </td>
