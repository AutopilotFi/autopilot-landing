      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-6">
            Autopilot vs. Standalone Morpho Vaults Benchmark
          </h2>
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-8">
            Backtesting performance data comparing Autopilot&apos;s automated
            rebalancing strategy against individual Morpho USDC vaults on
            Mainnet over 6 months (1 Jan – 29 June 2025).
          </p>
        </div>
            ...
            <table className="w-full min-w-[520px]">
              ...
              <tbody className="divide-y divide-gray-200">
                {allVaultData.map((vault) => {
                  ...
                  const isAutopilotEntry =
                    vault.isAutopilot || vault.isAutopilotNet;
                  ...
                  return (
                    ...
                    >
                      <td
                        className={`sticky left-0 px-2 md:px-4 py-4 border-r border-gray-300 ${
                          vault.isAutopilot
                      ...
                      <td
                        className={`sticky left-[50px] md:left-[70px] px-2 md:px-4 py-4 border-r-2 border-gray-400 ${
                          vault.isAutopilot
                            ? "bg-gradient-to-r from-[#9159FF] to-[#7c3aed]"
                            : vault.isAutopilotNet
                              ? "bg-gradient-to-r from-[#a78bfa] to-[#8b5cf6]"
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The longer Autopilot runs, the more visible and significant its
                outperformance becomes compared to the best standalone Morpho
                vaults.
              </p>
            </div>
            ...
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-2 h-2 bg-[#9159FF] rounded-full mt-3"></div>
              <p className="text-lg text-gray-700 leading-relaxed">
                Both raw and net Autopilot performance are shown in the
                benchmark. Net results account for setup and management fees,
                which are negotiable with the IPOR DAO (the rebalancing
                infrastructure provider) and can be reduced through IPOR token
                holdings. Fee adjustments can be explored in the future to
                further improve net performance.
              </p>
            </div>
            ...
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-2 h-2 bg-[#9159FF] rounded-full mt-3"></div>
              <p className="text-lg text-gray-700 leading-relaxed">
                Beyond delivering competitive rates, Autopilot functions like a
                yield &quot;genie,&quot; always aware of the top-performing
                source at any moment. In its early months, outperformance is
                still crystallizing, but it remains positioned in the most
                favorable opportunities at all times.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
          ...
          <p className="text-xs text-gray-600 leading-relaxed">
            Past performance is not indicative of future results. APY data
            represents historical 6-month averages (1 Jan – 29 June 2025) and
            actual returns may vary. Autopilot performance includes the impact
            of rebalancing costs and management fees where applicable.
            Individual vault performance may be affected by market conditions,
            liquidity constraints, and protocol-specific factors.
          </p>
        </div>
      </div>
    </div>
